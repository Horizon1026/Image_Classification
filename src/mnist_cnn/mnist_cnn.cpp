...
void MnistCnn::Train(const std::string &mnist_data_path) {
    auto data_loader =
        torch::data::make_data_loader(torch::data::datasets::MNIST(mnist_data_path.c_str()).map(torch::data::transforms::Stack<>()), options_.batch_size);
...
void MnistCnn::Test(const std::string &mnist_data_path) {
    auto dataset = torch::data::datasets::MNIST(mnist_data_path.c_str(), torch::data::datasets::MNIST::Mode::kTest).map(torch::data::transforms::Stack<>());
